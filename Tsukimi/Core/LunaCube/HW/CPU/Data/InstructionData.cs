...
namespace Tsukimi.Core.LunaCube.HW.CPU.Data
{
    ...
    public enum Modifier : byte
    {
        ...
        BNP = 1 << 5, //Predict branch to not take
        BP_ND = 1 << 6  //Predict branch to take (implicit LR/CTR dest)
    }
    ...
    public class InstructionData
    {
        ...
        public static Dictionary<InstructionType, Instruction> instructionDataDictionary = new()
        {
            ...
            {
                InstructionType.Bc,
                new Instruction("bc", 0xfc000000, 0x40000000, [Operand.BO, Operand.BI, Operand.BD], Modifier.LK | Modifier.AA | Modifier.BP | Modifier.BNP)
            },
            {
                InstructionType.Sc,
            ...
            },
            {
                ...
                new Instruction("sync", 0xFF9FFFFF, 0x7c0004ac, [])
            },
            {
