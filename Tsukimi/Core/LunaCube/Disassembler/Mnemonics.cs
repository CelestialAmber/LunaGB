...
namespace Tsukimi.Core.LunaCube.Disassembler
{
    ...
    public class MnemonicData
    {
        static Dictionary<MnemonicType, Mnemonic> mnemonicDictionary = new()
        {
            ...
            {MnemonicType.CmpwiCrf,  new Mnemonic(InstructionType.Cmpi, "cmpwi", [ Operand.rA, Operand.simm ])},
            {MnemonicType.Cmpwi,  new Mnemonic(InstructionType.Cmpi, "cmpwi", [ Operand.crfD, Operand.rA, Operand.simm ])},
        ...
        public static MnemonicType TryFindMnemonicType(InstructionFields fields)
        {
            ...
            switch (instrType)
            {
                ...
                case InstructionType.Twi:
                    if (TO == 6) type = MnemonicType.Twgti;
                    else if (TO == 8) type = MnemonicType.Twllei;
        ...
        static int CalculateBranchMnemonicArrayIndex(bool conditionFlag, uint BI)
        {
            ...
            int conditionBit = conditionFlag ? 1 : 0;
            int index = ((BI & 0b11100) != 0 ? 0b1000 : 0) | (conditionBit << 2) | ((int)BI & 0b11);
            return index;
        }
